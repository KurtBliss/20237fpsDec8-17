...
func _enter_tree() -> void:
	...
	_notes_tab.name = "Notes"
	_notes_tab.wrap_mode = TextEdit.LINE_WRAPPING_BOUNDARY
	_notes_tab.highlight_current_line = true
	...
	add_control_to_dock(EditorPlugin.DOCK_SLOT_RIGHT_BL, _notes_tab)
...
func _exit_tree() -> void:
	...
	remove_control_from_docks(_notes_tab)
